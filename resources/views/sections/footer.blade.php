...
<section class="py-20 md:py-28 bg-base-200">
    <div class="max-w-4xl mx-auto px-6 text-center reveal">
        <h2 class="font-serif text-3xl md:text-5xl font-semibold leading-tight mb-8">
            ...
            <span class="reveal-line"><span class="text-primary italic font-normal">Sendiri?</span></span>
        </h2>
...
<div class="bg-secondary py-4 border-y border-secondary/30">
    <div class="marquee">
        <div class="marquee__track">
            @for ($i = 0; $i < 2; $i++)
                <span class="font-serif italic text-neutral-900 text-xl md:text-2xl whitespace-nowrap">Tenun
                    Tangan</span>
                <span class="font-sans text-neutral-900/50 text-xl">&middot;</span>
                <span class="font-serif italic text-neutral-900 text-xl md:text-2xl whitespace-nowrap">Motif
                    Otentik</span>
                <span class="font-sans text-neutral-900/50 text-xl">&middot;</span>
                <span class="font-serif italic text-neutral-900 text-xl md:text-2xl whitespace-nowrap">Songket</span>
                <span class="font-sans text-neutral-900/50 text-xl">&middot;</span>
                <span class="font-serif italic text-neutral-900 text-xl md:text-2xl whitespace-nowrap">Dobby</span>
                <span class="font-sans text-neutral-900/50 text-xl">&middot;</span>
                <span class="font-serif italic text-neutral-900 text-xl md:text-2xl whitespace-nowrap">Super</span>
                <span class="font-sans text-neutral-900/50 text-xl">&middot;</span>
                <span class="font-serif italic text-neutral-900 text-xl md:text-2xl whitespace-nowrap">Parang</span>
                <span class="font-sans text-neutral-900/50 text-xl">&middot;</span>
                <span class="font-serif italic text-neutral-900 text-xl md:text-2xl whitespace-nowrap">Sejak Turun
                    Temurun</span>
                <span class="font-sans text-neutral-900/50 text-xl">&middot;</span>
            @endfor
        </div>
...
<footer class="bg-neutral-950 text-white/60">
    <div class="max-w-7xl mx-auto px-6 md:px-16 pt-20 pb-12">
        <div class="flex flex-col md:flex-row justify-between gap-12 pb-16 border-b border-white/10">
    ...
    <div class="overflow-hidden select-none pointer-events-none" aria-hidden="true">
        <span class="block font-serif text-white/5 leading-none text-center whitespace-nowrap" style="font-size: 15vw;">
            AL HIJAZ
        </span>
    </div>
    ...
    <div class="border-t border-white/10">
        <div
            class="max-w-7xl mx-auto px-6 md:px-16 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs font-sans">
