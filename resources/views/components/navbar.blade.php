...
window.addEventListener('theme-changed', (e) => isDark = e.detail.theme === 'alhijaz-dark');"
    ...
    <div class="flex items-center justify-between">
        <a href="{{ url('/') }}" :class="scrolled ? 'text-base-content' : 'text-white'"
    ...
    <div x-show="mobileOpen" x-transition:enter="transition ease-out duration-200"
        ...
        style="display: none;">
        <a href="{{ url('/') }}#tentang" @click="mobileOpen = false"
            class="text-base-content font-sans text-sm">Tentang</a>
        <a href="{{ url('/') }}#katalog" @click="mobileOpen = false"
            class="text-base-content font-sans text-sm">Produk</a>
        <a href="{{ route('artikel.index') }}" @click="mobileOpen = false"
            class="text-base-content font-sans text-sm">Artikel</a>
        <a href="{{ url('/') }}#kontak" @click="mobileOpen = false"
            class="text-base-content font-sans text-sm">Kontak</a>
